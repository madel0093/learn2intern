...
--
-- Host: localhost
-- Generation Time: Sep 13, 2016 at 03:22 PM
...
CREATE TABLE IF NOT EXISTS `competitions` (
  ...
  `description` text,
  PRIMARY KEY (`id`),
  KEY `fk_competitions_1_idx` (`companyId`)
...
CREATE TABLE IF NOT EXISTS `faculties` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_faculties_1_idx` (`universityId`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `students` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_students_1_idx` (`facultyId`),
  KEY `fk_students_2_idx` (`userId`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `supervisors` (
  ...
  `userId` int(10) unsigned NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_supervisors_1_idx` (`companyId`),
  KEY `fk_supervisors_2_idx` (`userId`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `supervisors_competitions` (
  ...
  PRIMARY KEY (`supervisorId`,`competitionId`),
  KEY `fk_supervisors_competitions_1_idx` (`competitionId`)
...
CREATE TABLE IF NOT EXISTS `universities` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_universities_1_idx` (`cityId`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
ALTER TABLE `competitions`
  ADD CONSTRAINT `fk_competitions_1` FOREIGN KEY (`companyId`) REFERENCES `copmanies` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `copmanies`
--
ALTER TABLE `copmanies`
  ADD CONSTRAINT `fk_copmanies_1` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `faculties`
--
ALTER TABLE `faculties`
  ADD CONSTRAINT `fk_faculties_1` FOREIGN KEY (`universityId`) REFERENCES `universities` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `students`
--
ALTER TABLE `students`
  ADD CONSTRAINT `fk_students_1` FOREIGN KEY (`facultyId`) REFERENCES `faculties` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_students_2` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `supervisors`
--
ALTER TABLE `supervisors`
  ADD CONSTRAINT `fk_supervisors_1` FOREIGN KEY (`companyId`) REFERENCES `copmanies` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_supervisors_2` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `supervisors_competitions`
--
ALTER TABLE `supervisors_competitions`
  ADD CONSTRAINT `fk_supervisors_competitions_1` FOREIGN KEY (`competitionId`) REFERENCES `competitions` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_supervisors_competitions_2` FOREIGN KEY (`supervisorId`) REFERENCES `supervisors` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `universities`
--
ALTER TABLE `universities`
  ADD CONSTRAINT `fk_universities_1` FOREIGN KEY (`cityId`) REFERENCES `cities` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
