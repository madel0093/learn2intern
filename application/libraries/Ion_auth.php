...
class Ion_auth
{
	...
	public function is_company($id=false)
	{
		$this->ion_auth_model->trigger_events('is_company');

		$company_group = $this->config->item('company_group', 'ion_auth');

		return $this->in_group($company_group, $id);
	}
	public function is_supervisor($id=false)
	{
		$this->ion_auth_model->trigger_events('is_admin');

		$supervisor_group = $this->config->item('supervisor_group', 'ion_auth');

		return $this->in_group($supervisor_group, $id);
	}
	/**
	 * in_group
	 *
